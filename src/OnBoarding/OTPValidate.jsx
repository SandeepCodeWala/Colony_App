...
const styles = StyleSheet.create({
  ...
  title: { textAlign: 'center', fontSize: fonts.fs_28, color: '#1A1A1A', fontFamily: 'Poppins-Medium' },
  subtitle: { textAlign: 'center', fontSize: fonts.fs_18, color: colors.txtColor, fontFamily: 'Poppins-Regular', marginTop: 10, marginHorizontal: 20 },
  otpContainer: { width: '80%', alignSelf: 'center' },
  otpInput: { borderWidth: 1, borderRadius: 10, borderColor: '#B7782E', backgroundColor: '#F7F7F7', color: '#000', fontSize: fonts.fs_20, fontFamily: 'Poppins-Medium' },
  verifyBtn: { alignSelf: 'center', backgroundColor: '#B7782E', borderRadius: 25, marginTop: 10 },
  verifyBtnText: { color: colors.white, fontFamily: 'Poppins-Medium', fontSize: fonts.fs_16 },
  resendText: { textAlign: 'center', fontSize: fonts.fs_16, color: colors.txtColor, fontFamily: 'Poppins-Regular' },
  resendLink: { fontFamily: 'Poppins-Medium', color: '#2E43C5' },
  timerText: { textAlign: 'center', fontSize: fonts.fs_16, color: colors.txtColor, fontFamily: 'Poppins-Regular' },
  timerNumber: { fontFamily: 'Poppins-Medium', color: '#B7782E' },
});
