    ...
    >
      <Tab.Screen
        ...
        options={{
          tabBarLabel: 'Explore',
          tabBarIcon: ({ focused }) => (
            <Image source={AppImages.explore} style={iconStyle(focused)} />
          ),
        }}
      />
      <Tab.Screen
        ...
        options={{
          tabBarLabel: 'Book',
          tabBarIcon: ({ focused }) => (
            <Image source={AppImages.calender} style={iconStyle(focused)} />
          ),
        }}
      />
      <Tab.Screen
        ...
        options={{
          tabBarLabel: 'Loyalty',
          tabBarIcon: ({ focused }) => (
            <Image source={AppImages.loyalty} style={iconStyle(focused)} />
          ),
        }}
      />
      <Tab.Screen
        ...
        options={{
          tabBarLabel: 'Account',
          tabBarIcon: ({ focused }) => (
            <Image source={AppImages.Account} style={iconStyle(focused)} />
          ),
        }}
      />
    </Tab.Navigator>
